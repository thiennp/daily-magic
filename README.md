...
That records `002`–`016` as already applied without re-running SQL. The next deploy only applies new migration files (e.g. `017-onboarding-automation-created.sql`).
