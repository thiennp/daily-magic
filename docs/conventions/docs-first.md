...
2. **Is it product vocabulary or nav?** → [philosophy-and-copy-guideline.md](../product/philosophy-and-copy-guideline.md), [product-pillars.md](../product/product-pillars.md), [concepts.md](../product/concepts.md), [ux-simplification.md](../product/ux-simplification.md).
...
| User-visible copy, marketing, showcases                                      | [philosophy-and-copy-guideline.md](../product/philosophy-and-copy-guideline.md); run `philosophyUserFacingCopy.test.ts`                                              |
| Product pillar behavior (authoring, learn-from-usage, memory, team learning) | [product/product-pillars.md](../product/product-pillars.md) and matching guide chapters; **`rules-agent-witch-guides.mdc`**                                          |
