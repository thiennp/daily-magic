...
| Product pillar behavior (authoring, learn-from-usage, memory, team learning) | [product/product-pillars.md](../product/product-pillars.md) (**north star vs today** + pillar → doc map) and matching guide chapters; rule **`rules-agent-witch-guides.mdc`** |
