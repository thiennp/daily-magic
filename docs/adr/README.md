...
| [0007](0007-fractal-slice-architecture.md)              | Proposed | Fractal Slice Architecture for feature modules         |
| [0008](0008-project-composition-layers.md)              | Proposed | Project composition: catalog, binding, materialization |
...
| Feature slice layout (`public-api`, `internal/`)    | 0007, [fsa-workflows](../conventions/fsa-workflows.md)              |
| Project composition, pull into repo, knowledge      | 0008, [project-composition](../architecture/project-composition.md) |
