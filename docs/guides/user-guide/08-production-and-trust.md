...
| **Efficient memory** | Prior **Run** context and project snippets are stored and injected on the **Mac** (see **Knowledge** in [Chapter 4](04-mac-connect-and-bridge.md#local-knowledge-mac-app--efficient-memory)); Console **Search past runs** is separate. Treat folders and transcripts as sensitive; nothing uploads by default; team-wide memory policy is still maturing ([north star vs today](00-philosophy-and-vocabulary.md#north-star-vs-today)). |
