...
| AI registration / Agent Mail     | [ai-self-registration-webmcp.md](../../qa/ai-self-registration-webmcp.md) — method `none` works without a mailbox; `agentmail` returns 503 when the server key is missing |
