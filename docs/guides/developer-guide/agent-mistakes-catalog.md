...
| Treat AWL **Suggestions** as auto-published capabilities       | Local hints only; `capability_improvements` needs Console accept           | [user ch.7](../user-guide/07-capabilities-library-playbooks.md#local-hints-vs-cloud-improvements-pillar-2-vs-3)                                             |
