...
import { OFFICIAL_WORKFLOW_DEFINITION } from "@/lib/workflowOrchestration/definitions/vibeCodingAppFeature.definition";

describe("vibe-coding-app-feature official workflow definition", () => {
