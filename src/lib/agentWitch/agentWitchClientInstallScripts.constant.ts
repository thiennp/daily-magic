...
export const AGENT_WITCH_CLIENT_INSTALL_SCRIPT_NAMES = [
  ...
  "writerSessionTranscriptStore.ts",
  ...
  "buildAgentWitchLocalCloudBanner.ts",
  "buildAgentWitchLocalHarnessPage.ts",
  "buildAgentWitchLocalHarnessInstalledSection.ts",
  "buildAgentWitchLocalProjectsPage.ts",
  "buildAgentWitchLocalProjectDetailPage.ts",
  "agentWitchLocalProjectsRegistry.ts",
