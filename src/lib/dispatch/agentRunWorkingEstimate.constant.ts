...
export const AGENT_RUN_WORKING_ESTIMATE_INSTRUCTION = [
  "If the prompt says a working estimate was already recorded locally, skip re-estimating and proceed.",
  "Otherwise, before other progress, estimate how long this task will take:",
  ...
  "5. Never use [[AWAITING_INPUT]] to ask the operator to confirm an estimate — proceed automatically.",
].join("\n");
