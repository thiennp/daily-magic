...
import MacDeviceWakeModal from "@/features/macDevices/MacDeviceWakeModal";
    ...
    <>
      <div className="group relative">
        ...
        <div className="pointer-events-none absolute left-0 top-full z-20 w-64 pt-2 opacity-0 transition-opacity group-hover:pointer-events-auto group-hover:opacity-100">
          <div className="rounded-lg border border-gray-200 bg-white p-3 text-xs text-gray-600 shadow-theme-sm dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300">
