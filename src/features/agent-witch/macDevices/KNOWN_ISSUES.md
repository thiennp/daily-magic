...
| MAC_DEVICES-003 | No way to update or remove the local install from the This Mac row menu | This Mac row menu adds Update local (repair `curl \| bash` script that keeps the existing Mac link) + Delete local script via wake server |
