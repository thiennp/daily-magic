...
| MAC_DEVICES-003 | No way to update or remove the local install from the This Mac row menu | This Mac row menu adds Update local (modal with server `curl \| bash` install command) + Delete local script via wake server |
