    ...
    <figure className="opacity-80">
      ...
      >
        <header className="flex items-center gap-2 border-b border-zinc-800/80 bg-zinc-900/90 px-4 py-2.5">
          ...
          <span className="h-2 w-2 rounded-full bg-zinc-600" aria-hidden />
          <span className="h-2 w-2 rounded-full bg-zinc-600" aria-hidden />
          <p className="ml-2 text-[11px] font-medium text-zinc-500">
        ...
        <section className="space-y-3 p-4">
          ...
          <p
            className="flex h-8 w-full items-center justify-center rounded-md border border-dashed border-zinc-700 bg-zinc-800/50 text-[11px] font-medium text-zinc-500"
            aria-hidden
          >
            Send to my Mac
          </p>
