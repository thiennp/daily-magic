...
| ID          | Symptom                                                                                   | Fix / test                                                                                                         |
| ----------- | ----------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ |
| LIBRARY-001 | Duplicate template installs cluttered New task with identical workflow rows and no delete | Archive from picker trash (AGENT-035); Library **Remove** archives workflows and agents                            |
