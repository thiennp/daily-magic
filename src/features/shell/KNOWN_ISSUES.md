...
| SHELL-002 | Primary nav exposed Library / Marketplace / Reports before core loop                          | UX-001: Home → New task → Job history; workflow onboarding optional (`docs/product/ux-simplification.md`) |
