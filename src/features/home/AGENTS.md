...
- **Install CTA** — show bash install (`curl … | bash`) only when cloud devices show no claimed/connected Mac (`shouldShowAgentWitchAppDownloadCta`); never probe localhost from the browser.
