export type ModalStatusAlertVariant = "success" | "info" | "warning" | "error";

export interface ModalStatusAlertConfig {
  readonly variant: ModalStatusAlertVariant;
...
export const MODAL_STATUS_ALERT_CONFIGS: readonly ModalStatusAlertConfig[] = [
  {
    variant: "success",
    triggerLabel: "Success Alert",
    triggerClassName:
      "px-4 py-3 text-sm font-medium text-white rounded-lg bg-success-500 shadow-theme-xs hover:bg-success-600",
    title: "Well Done!",
    message:
      "Lorem ipsum dolor sit amet consectetur. Feugiat ipsum libero tempor felis risus nisi non. Quisque eu ut tempor curabitur.",
    haloClassName: "fill-success-50 dark:fill-success-500/15",
    iconClassName: "fill-success-600 dark:fill-success-500",
    iconPath:
    ...
    buttonClassName:
      "flex justify-center w-full px-4 py-3 text-sm font-medium text-white rounded-lg bg-success-500 shadow-theme-xs hover:bg-success-600 sm:w-auto",
  },
  {
    variant: "info",
    triggerLabel: "Info Alert",
    triggerClassName:
      "px-4 py-3 text-sm font-medium text-white rounded-lg bg-blue-light-500 shadow-theme-xs hover:bg-blue-light-600",
    title: "Information Alert!",
    message:
      "Lorem ipsum dolor sit amet consectetur. Feugiat ipsum libero tempor felis risus nisi non. Quisque eu ut tempor curabitur.",
    haloClassName: "fill-blue-light-50 dark:fill-blue-light-500/15",
    iconClassName: "fill-blue-light-500 dark:fill-blue-light-500",
    iconPath:
    ...
    buttonClassName:
      "flex justify-center w-full px-4 py-3 text-sm font-medium text-white rounded-lg bg-blue-light-500 shadow-theme-xs hover:bg-blue-light-600 sm:w-auto",
  },
  {
    variant: "warning",
    triggerLabel: "Warning Alert",
    triggerClassName:
      "px-4 py-3 text-sm font-medium text-white rounded-lg bg-warning-500 shadow-theme-xs hover:bg-warning-600",
    title: "Warning Alert!",
    message:
      "Lorem ipsum dolor sit amet consectetur. Feugiat ipsum libero tempor felis risus nisi non. Quisque eu ut tempor curabitur.",
    haloClassName: "fill-warning-50 dark:fill-warning-500/15",
    iconClassName: "fill-warning-600 dark:fill-orange-400",
    iconPath:
    ...
    buttonClassName:
      "flex justify-center w-full px-4 py-3 text-sm font-medium text-white rounded-lg bg-warning-500 shadow-theme-xs hover:bg-warning-600 sm:w-auto",
  },
  {
    variant: "error",
    triggerLabel: "Danger Alert",
    triggerClassName:
      "px-4 py-3 text-sm font-medium text-white rounded-lg bg-error-500 shadow-theme-xs hover:bg-error-600",
    title: "Danger Alert!",
    message:
      "Lorem ipsum dolor sit amet consectetur. Feugiat ipsum libero tempor felis risus nisi non. Quisque eu ut tempor curabitur.",
    haloClassName: "fill-error-50 dark:fill-error-500/15",
    iconClassName: "fill-error-600 dark:fill-error-500",
    iconPath:
    ...
    buttonClassName:
      "flex justify-center w-full px-4 py-3 text-sm font-medium text-white rounded-lg bg-error-500 shadow-theme-xs hover:bg-error-600 sm:w-auto",
  },
];

const MODAL_STATUS_HALO_PATH =
