export const APP_SURFACE_NESTED_CARD_CLASS =
  "rounded-xl border border-gray-200 bg-white/80 p-4 dark:border-gray-800 dark:bg-white/[0.03]";
...
export const APP_SURFACE_HERO_NEUTRAL_CLASS =
  "overflow-hidden rounded-3xl border border-gray-200/80 bg-gradient-to-br from-brand-50 via-white to-white p-8 shadow-theme-sm ring-1 ring-gray-200/50 dark:border-gray-800 dark:from-brand-950/30 dark:via-white/[0.02] dark:to-white/[0.02]";

export const APP_SURFACE_HERO_BRAND_CLASS =
  "overflow-hidden rounded-3xl border border-brand-200/80 bg-gradient-to-br from-brand-50 via-white to-white p-8 shadow-theme-sm ring-1 ring-brand-100/80 dark:border-brand-900/40 dark:from-brand-950/30 dark:via-white/[0.02] dark:to-white/[0.02] dark:ring-brand-900/30";
